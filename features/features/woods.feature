...
Feature: Testing Feature Woods

@feature
Scenario: Woods on a Grassland tile
verifying basic setup of a Woods tile on Grassland
...
@feature
Scenario: Woods on a Plains tile
verifying basic setup of a Woods tile on plains
